<template>
  <div>
        ...
        <div class="col-md-12">
          <div class="d-flex">
            <div
              ...
              @click="toggleModal('stockModal', true, false)"
        ...
        <template v-slot:cell(action)="data">
          <div>
            ...
            <b-button
              ...
              @click="toggleModal('stockModal', true, true, data.item)"
          ...
          <table class="table">
            <tbody>
              <tr>
                ...
                <td>
                  {{ (data.item.barcode = !null ? data.item.barcode : "") }}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  {{
                    (data.item.mainBarcode = !null ? data.item.mainBarcode : "")
                  }}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  {{
                    (data.item.storageCode = !null ? data.item.storageCode : "")
                  }}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  {{ (data.item.buyingKdv = !null ? data.item.buyingKdv : "") }}
                </td>
              </tr>
            </tbody>
          </table>
    ...
    <stock-modal
      ref="stockModal"
      :show="stockModal.view"
      @close="toggleModal('stockModal')"
    ></stock-modal>
  </div>
</template>
