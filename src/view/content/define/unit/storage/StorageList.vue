<template>
  <div class="tableFixHead">
    ...
    <b-modal
      id="modal-storage-edit"
      ref="modal"
      title="Depo Güncelleme İşlemi"
      @ok="updateItem"
      no-close-on-backdrop
      ok-title="Güncelle"
      cancel-title="Vazgeç"
    >
      <label class="text-dark">Depo Kodu</label>
      <b-form-input v-model="modalData.code"></b-form-input>
      <br />
      <label class="text-dark">Depo Adı</label>
...
export default {
  ...
  methods: {
    ...
    deleteItem(data) {
      this.$bvModal
        .msgBoxConfirm(
          data.item.code + " öğesi silinecektir onaylıyor musunuz?",
          {
            okTitle: "Evet",
            cancelTitle: "Vazgeç",
          }
